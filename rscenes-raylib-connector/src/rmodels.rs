...
pub trait Rmodels: Debug {
    ...
    fn get_raycollision_triangle(
        ...
        RmodelsImpl::__get_raycollision_triangle(ray, p1, p2, p3)
    }
    ...
    fn get_raycollision_quad(
        ...
        RmodelsImpl::__get_raycollision_quad(ray, p1, p2, p3, p4)
    }
}
