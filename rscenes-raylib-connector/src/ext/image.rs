...
impl ImageExt for Image {
    ...
    fn is_ready(self) -> bool {
        RtexturesImpl::__is_image_ready(self)
    }

    fn unload(self) {
        RtexturesImpl::__unload_image(self)
    }

    fn export(self, filename: impl Display) -> bool {
        RtexturesImpl::__export_image(self, filename)
    }

    fn export_to_memory(self, tpe: ImageType) -> Result<Vec<u8>, String> {
        RtexturesImpl::__export_image_to_memory(self, tpe)
    }

    fn export_as_code(self, filename: impl Display) -> bool {
        RtexturesImpl::__export_image_as_code(self, filename)
    }

    fn copy(self) -> Image {
        RtexturesImpl::__image_copy(self)
    }

    fn copy_rec(self, rec: Rectangle) -> Self {
        RtexturesImpl::__image_from_image(self, rec)
    }
    ...
    fn to_pot(&mut self, fill: Color) -> &mut Self {
        RtexturesImpl::__image_to_pot(self, fill);
        self
    }

    fn crop(&mut self, crop: Rectangle) -> &mut Self {
        RtexturesImpl::__image_crop(self, crop);
        self
    }

    fn alpha_crop(&mut self, threshold: f32) -> &mut Self {
        RtexturesImpl::__image_alpha_crop(self, threshold);
        self
    }

    fn alpha_clear(&mut self, color: Color, threshold: f32) -> &mut Self {
        RtexturesImpl::__image_alpha_clear(self, color, threshold);
        self
    }

    fn alpha_mask(&mut self, alpha_mask: Image) -> &mut Self {
        RtexturesImpl::__image_alpha_mask(self, alpha_mask);
        self
    }

    fn alpha_premultiply(&mut self) -> &mut Self {
        RtexturesImpl::__image_alpha_premultiply(self);
        self
    }

    fn blur_gaussian(&mut self, blur_size: i32) -> &mut Self {
        RtexturesImpl::__image_blur_gaussian(self, blur_size);
        self
    }

    fn resize(&mut self, width: i32, height: i32) -> &mut Self {
        RtexturesImpl::__image_resize(self, width, height);
        self
    }

    fn resize_nn(&mut self, width: i32, height: i32) -> &mut Self {
        RtexturesImpl::__image_resize_nn(self, width, height);
        self
    }
    ...
    fn resize_canvas(
        ...
        RtexturesImpl::__image_resize_canvas(self, width, height, offset_x, offset_y, fill);
        self
    }

    fn compute_mipmaps(&mut self) -> &mut Self {
        RtexturesImpl::__image_mipmaps(self);
        self
    }

    fn dither(&mut self, r: i32, g: i32, b: i32, a: i32) -> &mut Self {
        RtexturesImpl::__image_dither(self, r, g, b, a);
        self
    }

    fn flip(&mut self) -> &mut Self {
        RtexturesImpl::__image_flip_vertical(self);
        self
    }

    fn flop(&mut self) -> &mut Self {
        RtexturesImpl::__image_flip_horizontal(self);
        self
    }

    fn rotate(&mut self, angle: f32) -> &mut Self {
        RtexturesImpl::__image_rotate(self, angle);
        self
    }

    fn color_tint(&mut self, tint: Color) -> &mut Self {
        RtexturesImpl::__image_color_tint(self, tint);
        self
    }

    fn color_invert(&mut self) -> &mut Self {
        RtexturesImpl::__image_color_invert(self);
        self
    }

    fn color_grayscale(&mut self) -> &mut Self {
        RtexturesImpl::__image_color_grayscale(self);
        self
    }

    fn color_constrast(&mut self, contrast: f32) -> &mut Self {
        RtexturesImpl::__image_color_contrast(self, contrast);
        self
    }

    fn color_brightness(&mut self, brightness: i32) -> &mut Self {
        RtexturesImpl::__image_color_brightness(self, brightness);
        self
    }

    fn color_replace(&mut self, color: Color, replace: Color) -> &mut Self {
        RtexturesImpl::__image_color_replace(self, color, replace);
        self
    }

    fn load_palette(self, max_size: usize) -> Result<Vec<Color>, String> {
        RtexturesImpl::__load_image_pallete(self, max_size as i32)
    }

    fn get_alpha_border(self, threshold: f32) -> Rectangle {
        RtexturesImpl::__get_image_alpha_border(self, threshold)
    }

    fn get_color(self, x: i32, y: i32) -> Color {
        RtexturesImpl::__get_image_color(self, x, y)
    }

    fn clear_background(&mut self, color: Color) -> &mut Self {
        RtexturesImpl::__image_clear_background(self, color);
        self
    }

    fn draw_pixel(&mut self, x: i32, y: i32, color: Color) -> &mut Self {
        RtexturesImpl::__image_draw_pixel(self, x, y, color);
        self
    }

    fn draw_pixel_v(&mut self, position: Vector2, color: Color) -> &mut Self {
        RtexturesImpl::__image_draw_pixel_v(self, position, color);
        self
    }
    ...
    fn draw_line(
        ...
        RtexturesImpl::__image_draw_line(self, start_x, start_y, end_x, end_y, color);
        self
    }

    fn draw_line_v(&mut self, start: Vector2, end: Vector2, color: Color) -> &mut Self {
        RtexturesImpl::__image_draw_line_v(self, start, end, color);
        self
    }
    ...
    fn draw_circle(
        ...
        RtexturesImpl::__image_draw_circle(self, center_x, center_y, radius, color);
        self
    }

    fn draw_circle_v(&mut self, center: Vector2, radius: i32, color: Color) -> &mut Self {
        RtexturesImpl::__image_draw_circle_v(self, center, radius, color);
        self
    }
    ...
    fn draw_circle_lines(
        ...
        RtexturesImpl::__image_draw_circle_lines(self, center_x, center_y, radius, color);
        self
    }

    fn draw_circle_lines_v(&mut self, center: Vector2, radius: i32, color: Color) -> &mut Self {
        RtexturesImpl::__image_draw_circle_lines_v(self, center, radius, color);
        self
    }
    ...
    fn draw_rectangle(
        ...
        RtexturesImpl::__image_draw_rectangle(self, x, y, width, height, color);
        self
    }

    fn draw_rectangle_v(&mut self, position: Vector2, size: Vector2, color: Color) -> &mut Self {
        RtexturesImpl::__image_draw_rectangle_v(self, position, size, color);
        self
    }

    fn draw_rectangle_rec(&mut self, rec: Rectangle, color: Color) -> &mut Self {
        RtexturesImpl::__image_draw_rectangle_rec(self, rec, color);
        self
    }

    fn draw_rectangle_lines(&mut self, rec: Rectangle, thick: i32, color: Color) -> &mut Self {
        RtexturesImpl::__image_draw_rectangle_lines(self, rec, thick, color);
        self
    }
    ...
    fn draw_image(
        ...
        RtexturesImpl::__image_draw(self, src, src_rec, dst_rec, tint);
        self
    }
    ...
    fn draw_text(
        ...
        RtexturesImpl::__image_draw_text(self, text, x, y, font_size, color);
        self
    }
    ...
    fn draw_text_ex(
        ...
        RtexturesImpl::__image_draw_text_ex(self, font, text, position, font_size, spacing, tint);
        self
    }
}
